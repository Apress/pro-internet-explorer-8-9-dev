...
using ProIeDev.HelpMenuItemComObject.Interfaces;
using ProIeDev.HelpMenuItemComObject.Enums;
using ProIeDev.HelpMenuItemComObject.Forms;
using ProIeDev.HelpMenuItemComObject.Structs;
using System.Reflection;
using ProIeDev.HelpMenuItemComObject.Classes;

#endregion Using Directives

namespace ProIeDev.HelpMenuItemComObject {
   ...
   public class Plugin : IOleCommandTarget {
      ...
      /// </summary>
      public const string Guid = @"C399BA47-12FA-4E6F-806C-D5CF1632F667";

      /// <summary>
      /// ProgId of this plugin
      /// </summary>
      public const string ProgId = "ProIeDev.HelpMenuItemComObject.Button";
      ...
      /// </summary>
      public const string PluginGuid = "{2C0EF61F-B6CE-44BC-888C-8737C9C42B4D}";
      ...
      public static Settings PluginSettings { 
         get { return new Settings() {
            ...
            //  Menu Text
            { "MenuText", "HelpMenuItemComObject Example" },

            //  Status bar text
            { "MenuStatusBar", "HelpMenuItemComObject Example" },
