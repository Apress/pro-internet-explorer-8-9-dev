...
using ProIeDev.ToolsMenuItemComObject.Interfaces;
using ProIeDev.ToolsMenuItemComObject.Enums;
using ProIeDev.ToolsMenuItemComObject.Forms;
using ProIeDev.ToolsMenuItemComObject.Structs;
using System.Reflection;
using ProIeDev.ToolsMenuItemComObject.Classes;

#endregion Using Directives

namespace ProIeDev.ToolsMenuItemComObject {
   ...
   public class Plugin : IOleCommandTarget {
      ...
      /// </summary>
      public const string Guid = @"C9756D47-DA0B-43DD-AF4E-71CA6ACC1765";

      /// <summary>
      /// ProgId of this plugin
      /// </summary>
      public const string ProgId = "ProIeDev.ToolsMenuItemComObject.Button";
      ...
      /// </summary>
      public const string PluginGuid = "{ED058781-5736-4EFF-AB5D-0A9CDE070371}";
      ...
      public static Settings PluginSettings { 
         get { return new Settings() {
            ...
            //  Menu Text
            { "MenuText", "ToolsMenuItemComObject Example" },

            //  Status bar text
            { "MenuStatusBar", "ToolsMenuItemComObject Example" },
      ...
      /// </summary>
      [STAThread]
      public void OnToolsMenuItemClick() {
